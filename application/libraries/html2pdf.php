...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__).'/html2pdf/v4.03/exception.class.php');
    require_once(dirname(__FILE__).'/html2pdf/v4.03/locale.class.php');
    require_once(dirname(__FILE__).'/html2pdf/v4.03/myPdf.class.php');
    require_once(dirname(__FILE__).'/html2pdf/v4.03/parsingHtml.class.php');
    require_once(dirname(__FILE__).'/html2pdf/v4.03/parsingCss.class.php');
